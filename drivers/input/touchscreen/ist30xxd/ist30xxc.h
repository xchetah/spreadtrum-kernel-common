...
#if defined(CONFIG_MACH_SS_SHARKLT8) || defined(CONFIG_MACH_SS_SHARKLT8LIGHTSLEEP)|| defined(CONFIG_MACH_SP9830I_J3LTE) || defined(CONFIG_MACH_TABELTE) || (CONFIG_MACH_SP9830I_J2LTE) || defined(CONFIG_MACH_SHARKLS_J3VLT)
...
#if defined(CONFIG_MACH_SS_SHARKLT8) || defined(CONFIG_MACH_SS_SHARKLT8LIGHTSLEEP) || defined(CONFIG_MACH_SP9830I_J3LTE) ||defined(CONFIG_MACH_TABELTE) || defined(CONFIG_MACH_SP9830I_J2LTE) || defined(CONFIG_MACH_SHARKLS_J3VLT)
