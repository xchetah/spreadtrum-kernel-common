...
static DEVICE_ATTR(bin_version, 0666, mip_sys_bin_version, NULL);
#endif
...
static DEVICE_ATTR(mode_edge_correction, 0666, mip_sys_mode_show, mip_sys_mode_store);
#if (CHIP_MODEL == CHIP_MCS8040L)
...
static DEVICE_ATTR(image_debug, 0666, mip_sys_debug, NULL);
#if ((CHIP_MODEL == CHIP_MMS500) || (CHIP_MODEL == CHIP_MFS10))
static DEVICE_ATTR(image_hybrid_rawdata, 0666, mip_sys_image, NULL);
static DEVICE_ATTR(image_hybrid_intensity, 0666, mip_sys_image, NULL);
#endif
#if (CHIP_MODEL == CHIP_MCS8040L)
#else
static DEVICE_ATTR(test_cm_delta, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_cm_abs, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_cm_jitter, 0666, mip_sys_test, NULL);
#endif
#if ((CHIP_MODEL == CHIP_MIT200) || (CHIP_MODEL == CHIP_MIT300))
static DEVICE_ATTR(test_short, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_short2, 0666, mip_sys_test, NULL);
#else
#if (CHIP_MODEL == CHIP_MCS8040L)
#else
static DEVICE_ATTR(test_short, 0666, mip_sys_test_short, NULL);
#endif
#endif
#if (CHIP_MODEL == CHIP_MCS8040L)
static DEVICE_ATTR(test_self_cp, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_self_jitter, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_self_diff_horizontal, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_self_diff_vertical, 0666, mip_sys_test, NULL);
#endif
#if ((CHIP_MODEL == CHIP_MMS500) || (CHIP_MODEL == CHIP_MFS10))
static DEVICE_ATTR(test_hybrid_self_cp, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_hybrid_self_jitter, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_hybrid_self_diff_horizontal, 0666, mip_sys_test, NULL);
static DEVICE_ATTR(test_hybrid_self_diff_vertical, 0666, mip_sys_test, NULL);
#endif
#if MIP_USE_WAKEUP_GESTURE
static DEVICE_ATTR(wakeup_gesture, 0666, mip_sys_wakeup_gesture, NULL);
static DEVICE_ATTR(debug_gesture, 0666, mip_sys_debug, NULL);
static DEVICE_ATTR(mode_gesture_debug, 0666, mip_sys_mode_show, mip_sys_mode_store);
#endif
static DEVICE_ATTR(proximity_sensor, 0666, mip_sys_proximity_sensor, NULL);
