...
//Firmware update
#define FW_PATH_INTERNAL			"melfas/melfas_mip4_tk_j2xnlte.fw"		//path of firmware included in the kernel image (/firmware)
#define FW_PATH_EXTERNAL			"/sdcard/melfas_mip4_tk_j2xnlte.fw"	//path of firmware in external storage
