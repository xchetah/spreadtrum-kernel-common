...
static LCM_Init_Code init_data[] = {
	...
	{LCM_SLEEP(1)},
	{LCM_SEND(5), {3,0,0xB3,0x00,0x8E}},//VCOM
	{LCM_SLEEP(1)},
	{LCM_SEND(5), {3,0,0xB4,0x00,0x8E}},//VCOM_R
	{LCM_SLEEP(1)},
	{LCM_SEND(9), {7,0,0xB8,0x00,0x9F,0x01,0x00,0x9F,0x01}},//VGMP, VGSP, VGMN  
	{LCM_SLEEP(1)},  	
	{LCM_SEND(6), {4,0,0xBA,0x3E,0x23,0x04}},//GIP output volta
	{LCM_SLEEP(1)},
	{LCM_SEND(2), {0xC3,0x02}},//column
	{LCM_SLEEP(1)},
	{LCM_SEND(5), {3,0,0xC4,0x30,0x6A}},//TCON
	{LCM_SLEEP(1)},
	{LCM_SEND(12), {10,0,0xC7,0x00,0x01,0x31,0x0A,0x6A,0x2A,0x13,0xA5,0xA5}},//POWER CTRL
	{LCM_SLEEP(1)},
	//Gamma
	{LCM_SEND(41), {39,0,0xC8,0x74,0x70,0x2C,0x3A,0x1C,0x11,0x17,0x06,0x24,0x29,
			...
			0x2F,0x55,0x4B,0x5D,0x58,0x61,0x5D,0x57,0x50}},
	{LCM_SLEEP(1)},
	{LCM_SEND(13), {11,0,0xD4,0x1F,0x1F,0x1F,0x03,0x01,0x05,0x07,0x09,0x0B,0x11,
			0x13,0x1F,0x1F,0x1F,0x1F,0x1F}},				//SET GIP_L
	{LCM_SLEEP(1)},
	{LCM_SEND(13), {11,0,0xD5,0x1F,0x1F,0x1F,0x02,0x00,0x04,0x06,0x08,0x0A,0x10,
			0x12,0x1F,0x1F,0x1F,0x1F,0x1F}},				//SET GIP_R
	{LCM_SLEEP(1)},
	{LCM_SEND(13), {11,0,0xD6,0x1F,0x1F,0x1F,0x10,0x12,0x04,0x0A,0x08,0x06,0x02,
			0x00,0x1F,0x1F,0x1F,0x1F,0x1F}},				//SET GIP_GS_L
	{LCM_SLEEP(1)},
	{LCM_SEND(13), {11,0,0xD7,0x1F,0x1F,0x1F,0x11,0x13,0x05,0x08,0x09,0x07,0x03,
			0x01,0x1F,0x1F,0x1F,0x1F,0x1F}},				//SET GIP_GS_R
	{LCM_SLEEP(1)},
	{LCM_SEND(17), {15,0,0xD8,0x20,0x00,0x00,0x30,0x03,0x30,0x01,0x02,0x30,0x01,0x02,0x06,0x70,
			0x73,0x5D,0x72,0x06,0x38,0x70,0x08}},		//SET GIP1
	{LCM_SLEEP(1)},
	{LCM_SEND(16), {14,0,0xD9,0x00,0x0A,0x0A,0x88,0x00,0x00,0x06,0x7B,0x00,0x80,
			0x00,0x3B,0x33,0x1F,0x00,0x00,0x00,0x06,0x70}},			//SET GIP2
	{LCM_SLEEP(1)},
