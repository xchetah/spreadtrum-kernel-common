...
#ifndef CONFIG_MACH_SHARKLS_J3LTE_V0 
//for future use
...
int32_t s6e8aa5x01_panel_after_suspend(struct panel_spec *self)
{
	return kpled_power_on(0);
}
int32_t s6e8aa5x01_panel_before_resume(struct panel_spec *self)
{
...
#ifdef  CONFIG_FB_LCD_OLED_BACKLIGHT
...
#endif
#ifndef CONFIG_MACH_SHARKLS_J3LTE_V0
	.panel_after_suspend=s6e8aa5x01_panel_after_suspend,
	.panel_before_resume=s6e8aa5x01_panel_before_resume,
#endif
